...
var Ba = class {
    ...
    seal({
        ...
        const e = this;
        return h(function*() {
            if (a.length !== e.A) throw new E("Unexpected key length: " + a.length.toString());
        ...
        constructor(a, b) {
            ...
            if (a) {
                ...
                if (a.hpkePublicKey.params.kem === "DHKEM_P256_HKDF_SHA256" && c === "HKDF_SHA256" && d === "AES_128_GCM") {
                    ...
                    try {
                        let e;
                        const f = D((e = this.v) == null ? void 0 : e.hpkePublicKey.publicKey);
...
var nb = function(a, b) {
    ...
    ob = function(a, b) {
        b && (Y(b.send_pixel, b.options, a.i), Y(b.create_iframe, b.options, a.v), Y(b.fetch, b.options, a.h))
    },
    pb = function(a, b) {
        b = a.g + b;
        let c = b.indexOf("\n\n");
...
var ub = function(a, b, c) {
        return h(function*() {
            ...
            const e = d,
                f = new $a(e, a.g.btoa);
            return tb(a, a.g.performance.now(), (e == null ? void 0 : e.id) || "undefined", f.encrypt(b))
        })
    },
    vb =
    function(a, b, c) {
        return h(function*() {
            return tb(a, a.g.performance.now(), "unknown", gb(c.encryptionKeyString || "").encryptMessage(b).then(d => ({
    ...
    wb = function(a, b, c) {
        return h(function*() {
            ...
            const {
                ...
                const t = a.h[l];
                if (t ==
                    null) throw Error(`Unknown filter: ${l}`);
                return z => h(function*() {
                    return yield t(z, b)
                })
            };
