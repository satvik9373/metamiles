var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function(o) {
        var n = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
            ...
            j = {
                ...
                highlight: function(e, t, n) {
                    ...
                    if (j.hooks.run("before-tokenize", n), !n.grammar) throw new Error('The language "' + n.language + '" has no grammar.');
                    return n.tokens = j.tokenize(n.code, n.grammar), j.hooks.run("after-tokenize", n), C.stringify(j.util.encode(n.tokens), n.language)
                },
                            ...
                            for (var l in a)
                                if (a.hasOwnProperty(l) && a[l]) {
                                    ...
                                    for (var u = 0; u < o.length; ++u) {
                                        ...
                                        for (var f = c.pattern || c, b = r.next, y = s; b !== n.tail && !(i && y >= i.reach); y += b.value.length, b = b.next) {
                                            var v = b.value;
        ...
        return a && (j.filename = a.src, a.hasAttribute("data-manual") && (j.manual = !0)), j.manual || ("loading" === (e = document.readyState) || "interactive" === e && a && a.defer ? document.addEventListener("DOMContentLoaded", r) : window.requestAnimationFrame ? window.requestAnimationFrame(r) : window.setTimeout(r, 16)), j
    }(_self);
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
    ...
    function() {
        var o, u, g, c, e;
        void 0 !== Prism && "undefined" != typeof document && (Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), o = {
            js: "javascript",
            py: "python",
            rb: "ruby",
            ps1: "powershell",
            ...
            var r, t, n, a, s, i, l = e.element;
            l.matches(c) && (e.code = "", l.setAttribute(u, g), (r = l.appendChild(document.createElement("CODE"))).textContent = "Loading…", n = l.getAttribute("data-src"), "none" === (e = e.language) && (t = (/\.(\w+)$/.exec(n) || [, "none"])[1], e = o[t] || t), Prism.util.setLanguage(r, e), Prism.util.setLanguage(l, e), (t = Prism.plugins.autoloader) && t.loadLanguages(e), n = n, a = function(e) {
