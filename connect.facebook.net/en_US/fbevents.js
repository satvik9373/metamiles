            ...
            return function(g, i, j, k) {
                ...
                (function() {
                    ...
                    var z = f.getFbeventsModules("SignalsFBEventsEventValidationConfigTypedef"),
                        ...
                        O = f.getFbeventsModules("SignalsFBEventsProhibitedPixelConfigTypedef"),
                        P = "global",
                        Q = {
                            automaticMatching: a,
                            openbridge: r,
                ...
                (function() {
                    k.exports = function(a) {
                        ...
                        var Z = l.each,
                            Zb = l.filter,
                            $b = l.reduce,
                            ac = ["product", "product_group", "vehicle", "automotive_model"],
                        ...
                        function ec(a) {
                            ...
                            d = "string" == typeof a.additionalType && ac.includes(a.additionalType) ? a.additionalType : null;
                            a = [b, c];
                            b = {};
                            return (a = Zb(a, function(a) {
                                return null != a
                        ...
                        function gc(a) {
                            ...
                            var c = null;
                            return null != a && a.length > 0 && (c = $b(a, function(a, b) {
                                b = b.value;
                                if (null == b) return a;
                                try {
                                    b = parseFloat(b);
                        ...
                        var mc = {
                                ...
                                reduceCustomData: function(a) {
                                    ...
                                    var b = $b(a, function(a, b) {
                                        return Z(Object.keys(b), function(c) {
                                            var d = b[c],
                                                e = a[c];
                                            if (null == e) a[c] = d;
                                    ...
                                    return Z(Object.keys(b), function(a) {
                            ...
                            tc = "Outbound",
                            uc = "Download",
                            vc = [".pdf", ".docx", ".doc", ".txt", ".jpg", ".jpeg", ".png", ".gif", ".mp3", ".wav", ".ogg", ".zip", ".rar", ".7z", ".exe", ".msi", ".xlsx", ".xls", ".pptx", ".ppt"],
                            wc = function(a) {
                                var b = [],
                                    c = f.location.hostname,
                                    d = a.getAttribute("href");
                                return null !== d && "" !== d && "string" == typeof d && (d.startsWith("http://") || d.startsWith("https://")) && (new URL(d).host !== c && b.push(tc), vc.some(function(a) {
                                    return d.endsWith(a)
                                }) && b.push(uc)), b
                            },
                            xc = l.filter(R.split(Q), function(a) {
                                return "a" !== a
                            }).join(Q),
                            yc = function a(b, c) {
                                if (null == b || !Xa(b)) return null;
                                if (pc(b, c ? R : xc)) return b;
                                if (pc(b, Ma)) {
                                    var d = wc(b);
                            ...
                            Ec = ["gtin", "gtin8", "gtin12", "gtin13", "gtin14", "isbn"];

                        function Fc(a) {
                            return null != Ac(Cc, function(b) {
                                return b === a
                            })[0]
                        }

                        function Gc(a, b) {
                            return null != Ac(Dc, function(c) {
                        ...
                        function Jc() {
                            for (var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], b = g.querySelectorAll("[itemscope]"), c = [], d = new Bc(), e = 0; e < b.length; e++) d.add(b[e]);
                                    ...
                                    for (var z = {}, L = y.querySelectorAll("[itemprop]"), A = 0; A < L.length; A++) {
                                        ...
                                        if (!d.has(M)) {
                                            ...
                                            if ("string" == typeof B && "" !== B) {
                                                ...
                                                if (null != N) {
                                                    var C = z[B];
                                                    null != C && Gc(K, B) ? Array.isArray(C) ? z[B].push(N) : z[B] = [C, N] : (N && (null == k.productID && ("productID" === B ? f = N : "sku" === B && (h = N)), null == k.productUrl && "url" === B && (k.productUrl = N), a && (null == k.automaticParameters.currency && "priceCurrency" === B && (k.automaticParameters.currency = N), null != i.id || "productID" !== B && "sku" !== B || (i.id = N), null == i.mpn && "mpn" === B && (i.mpn = N), null == i.gtin && Ec.includes(B) && (i.gtin = N), null == i.item_price && "price" === B && $(i, "item_price", Nc(N)), null == i.availability && "availability" === B && (i.availability = Rc(N)))), z[B] = N)
                                                }
                                            }
                                        }
                                    }
                            ...
                            null != f ? k.productID = f : null != h && (k.productID = h), Mc(k, a, [i]);
                        ...
                        function Kc() {
                            for (var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], b = {
                                ...
                                var j = e[i],
                                    k = j.innerText;
                                if (null != k && "" !== k) try {
                                    if ((f += k.length) > 12e4) return Mc(b, a, h), {
                                    ...
                                    for (var o = function() {
                                            ...
                                            if (f) {
                                                var i = Oc(d);
                                                null != b.productID && "" !== b.productID || (b.productID = i), a && ($(g, "id", i), $(g, "mpn", d.mpn), $(g, "gtin", Pc(d)))
                                            }
                                            if ((null == b.productUrl || "" === b.productUrl || f) && d.url && (b.productUrl = d.url), (null == b.productUrl || f) && null != d.offers)
                                                if (Array.isArray(d.offers) && d.offers.length > 0) zc(d.offers, function(c) {
                                                    if (null == b.productUrl && c.url && (b.productUrl = c.url), a) {
                                                        ...
                                                        var d = {};
                                                        $(d, "id", Oc(c, g.id)), $(d, "mpn", c.mpn ? c.mpn : g.mpn), $(d, "gtin", Pc(c, g.gtin)), $(d, "item_price", Nc(c.price)), c.availability && (d.availability = Rc(c.availability)), Hc(d) || h.push(d)
                                                    }
                                                });
                                                else {
                                                    i = "offer" === (e = Lc(d.offers)) || "http://schema.org/offer" === e;
                                                    null == b.productUrl && i && d.offers.url && (b.productUrl = d.offers.url), i && a && (null == b.automaticParameters.currency && d.offers.priceCurrency && (b.automaticParameters.currency = d.offers.priceCurrency), $(g, "item_price", Nc(d.offers.price)), d.offers.availability && (g.availability = Rc(d.offers.availability)), Hc(g) || h.push(g))
                                                }
                                            c.push(d)
                                        }, q = 0; q < p.length; q++) o()
                                } catch (a) {
                        ...
                        function Qc() {
                            for (var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], b = {
                                    ...
                                    productID: null,
                                    productUrl: null
                                }, c = new Bc(["og", "product", "music", "video", "article", "book", "profile", "website", "twitter"]), d = {}, e = null, f = null, h = {}, i = g.querySelectorAll("meta[property]"), j = 0; j < i.length; j++) {
                                var k = i[j],
                                ...
                                if ("string" == typeof r && -1 !== r.indexOf(":") && "string" == typeof p && c.has(r.split(":")[0])) {
                                    var s = P(p, 500),
                                        q = d[r];
                                    null != q && Fc(r) ? Array.isArray(q) ? d[r].push(s) : d[r] = [q, s] : (s && (null != b.productID && "" !== b.productID || ("product:retailer_item_id" === r && (e = s), "product:sku" === r && (f = s)), null != b.productUrl && "" !== b.productUrl || "og:url" !== r || (b.productUrl = s), a && (null != b.automaticParameters.currency || "product:price:currency" !== r && "og:price:currency" !== r || (b.automaticParameters.currency = s), null != h.id || "product:retailer_item_id" !== r && "product:sku" !== r || (h.id = s), null == h.mpn && "product:mfr_part_no" === r && (h.mpn = s), null == h.gtin && Ec.map(function(a) {
                                        return "product:".concat(a)
                                    }).includes(r) && (h.gtin = s), null != h.item_price || "product:price:amount" !== r && "og:price:amount" !== r || $(h, "item_price", Nc(s)), null != h.availability || "product:availability" !== r && "og:availability" !== r || (h.availability = Rc(s)))), d[r] = s)
                                }
                            }
                            return null != e ? b.productID = e : null != f && (b.productID = f), Mc(b, a, [h]), {
                                extractedProperties: d,
                                productMetadata: b
                            }
                        }
                        ...
                        function Tc() {
                            for (var a = g.querySelector("title"), a = {
                                ...
                                "string" == typeof e && "string" == typeof d && Sc[e] && (a["meta:" + e] = P(d, 500))
                            }
                            return a
                        }
                        var Uc = ["PageView", "ViewContent", "AddToCart", "AddToWishlist", "AddPaymentInfo", "InitiateCheckout", "Purchase"];
    ...
    (function() {
        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.clienthint", function() {
            return function(a, b, c, d) {
                ...
                (function() {
                    "use strict";
                    var b = f.getFbeventsModules("signalsFBEventsShouldUseAsyncParamRefactor"),
                    ...
                    function A(a) {
                        a = l(a, n);
                        if (a == null) {
                            k(new Error("[ClientHint Error] getHighEntropyValues returned null from Android Chrome source"));
                            return new Map()
                        }
                        var b = new Map();
                    ...
                    function B(b, a) {
                        var c = !0,
                            ...
                            e = void 0;
                        try {
                            for (var f = s[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](), g; !(c = (g = f.next()).done); c = !0) {
                                g = g.value;
                    ...
                    e.exports = new c(function(c, e) {
                        ...
                        if (g == null) {
                            a.navigator.userAgentData != null && k(new Error("[ClientHint Error] UserAgentData coerce error"));
                            return
                        } else if (!o(a.navigator.userAgent)) return;
                        if (c) {
                            g = a.navigator.userAgentData.getHighEntropyValues(["model", "platformVersion", "fullVersionList"]).then(function(a) {
                                var b = e.asyncParamFetchers.get(v);
                                b != null && b.result == null && (b.result = a, e.asyncParamFetchers.set(v, b));
                                return a
                            })["catch"](function(a) {
                                a.message = "[ClientHint Error] Fetch error" + a.message, k(a)
                            });
                            e.asyncParamFetchers.set(v, {
                                request: g,
                                callback: C
                            });
                            ...
                            x === null && !b && (x = a.setTimeout(function() {
                                z(e, w, t)
                            }, c))
                        }), j.listen(function(a) {
                            if (!y) {
                                var b = a.customParams || new d(),
                                    ...
                                    g = void 0;
                                try {
                                    for (var h = s[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](), i; !(c = (i = h.next()).done); c = !0) {
                                        i = i.value;
