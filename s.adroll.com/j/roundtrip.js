window.__adroll || (function() {
    ...
    h.prototype._sync_page_category = function() {
        var a = this;
    ...
    h.prototype._clarity_filter_events = function(a) {
        if (!a) return [];
        var b = {
            0: !0,
            4: !0,
    ...
    h.prototype._clarity_log_event = function(a) {
    ...
    h.prototype._clarity_init = function() {
        var a = this;
        window.__adroll_clarity_started || (!0 === window.__adroll_consent || !0 === (window.__adroll_consent || {}).a ? (window.__adroll_clarity_started = !0, function(a, c, d, e, g, f, m) {
            a[d] = a[d] || function() {
    ...
    h.prototype._consent_cookie = function(a) {
        if (a) {
            var b = this._get_etld();
            b && this.set("__adroll_consent", a, -86400);
            this.set("__adroll_consent", a, 8760, b);
            return a
        }
        return this.get("__adroll_consent")
    };
    ...
    h.prototype.save_first_party_consent = function(a) {
        var b = (a || {}).euconsent;
    ...
    h.prototype.get_first_party_consent = function() {
    ...
    h.prototype.trigger_gtm_consent_event = function(a) {
        function b(a, b, c) {
        ...
        if (!window.dataLayer || "function" === typeof window.dataLayer.push)
            if (window.dataLayer = window.dataLayer || [], a) {
                var d = this._global("__adroll_consent"),
                    ...
                    r;
                if ("boolean" === typeof d) {
                    for (r = 0; r < m.length; r++) b(q, m[r], d);
                    for (r = 1; r < f; r++) b(q, r, d), b(l, r, d);
                    for (r = 1; 25 > r; r++) n[d][r] = 1
                } else {
                    for (r in d) d.hasOwnProperty(r) && b(q, r, d[r]);
                    for (r = 1; r <= f; r++) b(l, r, (g.vendor_consent || {})[r]);
                    for (r = 0; 24 > r; r++) n[!!(k & 1 << r)][r + 1] = 1
                }
    ...
    h.prototype._install_tcf_proxy = function() {
        if (this.cmpFrame || window.__tcfapi) return !0;
        for (var a = window, b = this; a;) {
            try {
        ...
        if (!this.cmpFrame) return !1;
        this.cmpCallbacks = {};
        window.__tcfapi = function(a, d, e, g) {
            if (!b.cmpFrame) throw Error("No CMP found");
            var f = Math.random() + "";
            b.cmpCallbacks[f] = e;
            b.cmpFrame.postMessage(b.jsonStringify({
                command: a,
                version: d,
                callId: f,
                parameter: g
        ...
        window.addEventListener("message",
            function(a) {
                var d = {};
                try {
                    d = "string" === typeof a.data ? b.jsonParse(a.data) : a.data
                } catch (e) {}
                if ((d = (d || {}).__tcfapiReturn) && "function" === typeof b.cmpCallbacks[d.callId]) b.cmpCallbacks[d.callId](d.returnValue, d.success)
            });
        return !0
    };
    h.prototype._wait_shopify_consent = function(a, b, c, d, e, g) {
        var f = this,
            m = g || {},
            k = !1;
        if ("object" !== typeof window.Shopify || !c || !0 !== a || "custom" !== (m.banner || "").substr(0, 6)) return !1;
        g = window.document.querySelectorAll("script");
        for (var q = !1, l = 0; l < g.length; l++)
            if (-1 !== g[l].src.indexOf("shopify_rolling_bootstrap")) {
                q = !0;
                break
            }
        if (!q) return this._log_pex_event("wait_shopify_consent", "not-integration"), !1;
        if (window.__tcfapi || this._install_tcf_proxy()) return m.banner = "shopify_tcf", this._log_pex_event("wait_shopify_consent",
            "wait-consent"), window.__tcfapi("addEventListener", 2, function(g) {
            g = g || {};
            "loaded" !== g.cmpStatus && "useractioncomplete" !== g.cmpStatus || !((g.vendor || {}).consents || {})[130] || k || (f._log_pex_event("wait_shopify_consent", "consent-allow"), k = !0, f.set_consent(a, b, c, d, e, m))
        }), !0;
        this._log_pex_event("wait_shopify_consent", "not-tcf22");
        return !1
    };
    h.prototype.set_consent = function(a, b, c, d, e, g) {
        ...
        if (!this._wait_shopify_consent(a, b, c, d, e, g)) {
            var f = ["5L5IV3X4ZNCUZFMLN5KKOD", "VMYZUWPHFRH37EAOEU2EQS", "3QOM4TKN4RD7TO3HCPYRKV"],
                m = this._global("adroll_adv_id");
            "CA" === d && 0 <= f.indexOf(m) && (c = !0, !0 === a && "" === ((g || {}).arconsent || "") && (a = null));
            f = "nextroll-consent";
            this._has_global("__adroll_consent") &&
                (f = "nextroll-consent-modified");
            ...
            g && (m = g.gppconsent || this.gpp_from_tcfstr(g.euconsent)) && (m = this.gpp_decode_string(m), this._set_global("__adroll_consent_gpp", m));
            c && ("adroll" === (g || {}).banner || b) && this.load_consent_banner();
            if (this._install_cmp) this._install_cmp();
            else {
                var k = this;
                window.setTimeout(function() {
                    k._install_cmp && k._install_cmp()
                }, 1E3)
            }
    ...
    h.prototype._load_precheck_js = function() {
    ...
    h.prototype._get_etld = function() {
    ...
    h.prototype.matchesSelector = function(a, b) {
    ...
    h.prototype._get_idb_row = function(a, b, c) {
        var d = this;
        if (this._adroll_idb)
    ...
    h.prototype._set_idb_row = function(a, b, c) {
    ...
    h.prototype.closest = function(a, b) {
    ...
    h.prototype.fibonacci = function() {
    ...
    h.prototype.fromfib = function(a) {
    ...
    h.prototype._run_cookieless_steps = function() {
    ...
    h.prototype._form_attach = function() {
        function a(a) {
            try {
                if (!a) return null;
    ...
    h.prototype._desc_el = function(a) {
        if (!a) return "";
    ...
    h.prototype._find_el = function(a, b) {
        var c;
        b = b || window.document;
        try {
            c = b.querySelector(a)
    ...
    h.prototype._form_data = function(a) {
    ...
    h.prototype._redact_pci = function(a) {
        a = a.split(/([\d\-\.\ ]+)/);
        for (var b = 0; b < a.length; b++) this.is_luhn(a[b]) && (a[b] = " <PCI_REDACTED> ");
        return a.join("")
    };
    h.prototype._xhr = function(a) {
        a = a || {};
    ...
    h.prototype._form_tp_change = function(a) {
        a = a.target;
        this._form_el_tp_allowed(a) && this._form_tp_data(a)
    };
    h.prototype._get_form_tp_obj = function() {
        return this._adroll_tp_forms.map(this._get_tpform_sel)
    };
    h.prototype._form_tp_click = function(a) {
        a = a.target;
    ...
    h.prototype._set_tp_auth = function(a, b) {
        function c(a, b) {
            for (var g in a)
    ...
    h.prototype._form_tp_is_legitimate_interest = function(a, b) {
        var c = !1;
        if (b.context) {
    ...
    h.prototype._form_tp_save = function(a) {
        a = a.target;
        ...
        for (var c = this._get_form_tp_obj(), d = 0; d < c.length; d++) {
            ...
            if ((this.matchesSelector(a, e.form) || this.matchesSelector(a, e.iframeForm)) && null !== b) {
                var g = this._form_tp_provider_allowed()[e.name].has_marketing_consent_comm,
                    ...
                    m = (((b || {}).kind || {}).gdpr_consent || {}).val;
                !0 === g || "true" === g || f ||
                    m ? this._set_tp_auth(b, 1) : delete b.contact;
    ...
    h.prototype._form_tp_data = function(a, b) {
        ...
        if (!c) {
            ...
            if (e) {
                ...
                for (var g = null, f = ["email"], m = this._get_form_tp_obj(), k = 0; k < m.length; k++) {
                    var q = m[k];
                    if ((g = this.closest(a, q.form) || this.closest(a, q.iframeForm)) && (this.matchesSelector(g, q.form) || this.matchesSelector(g, q.iframeForm))) {
                        g = q.fields[a.name];
                        if (!g)
                            for (var l = this.object_keys(q.fields), n = 0; n < l.length; n++) {
                                var p = l[n],
                                    r = a.name;
    ...
    h.prototype._form_tp_attach = function(a) {
        function b() {
        ...
        if (g) {
            ...
            if (0 === f.length) b();
                ...
                for (var m = [], k = [], q, l, n, p, r = 0; r < f.length; r++) {
                    l = null;
                    var u = f[r];
                    if (g && g.hasOwnProperty(u))
                        if (q = this._get_tpform_sel(u), null !==
                            q.iframe && null !== q.form && (l = window.document.querySelector(q.iframe), (n = d(l)) && (p = n.body ? n.body.querySelector(q.iframeForm) : null)), null === q.form || p || (p = window.document.querySelector(q.form)), null === p) {
                            b();
                            continue
                        } else
                            for (m.push(u), q = this.object_keys(q.fields).map(q._field_sel), q = p.querySelectorAll(q), n = 0; n < q.length; n++) k.push(this._desc_tp_el(q[n])), this._form_tp_data(q[n], u);
    ...
    h.prototype._form_el_tp_allowed = function(a, b) {
    ...
    h.prototype._desc_tp_el = function(a) {
        if (!a) return "";
        var b = a.tagName.toLowerCase();
        ...
        q.prototype.fromString = function(a) {
            ...
            for (d = 0; d < e; d++)
                if (b = "1" === a[0], a = a.substr(1), g = new c, a = g.fromString(a), b) {
                    ...
                    a = g.fromString(a);
                    g = g.valueOf();
                    for (b = 0; b < g; b++) this.data.push(k + b);
                    k += g
                } else k += g.valueOf(),
                    this.data.push(k);
            return a
    ...
    h.prototype.GppStruct = function() {
        var a = this.GppTypes(),
    ...
    h.prototype.gpp_decode_string = function(a) {
        var b = {
                str: a,
                sections: {}
            },
    ...
    h.prototype.gpp_encode_string = function(a) {
    ...
    h.prototype.gpp_from_tcfstr = function(a) {
        if (!a) return null;
        var b = {
            B: "DBABYA",
            C: "DBABMA"
    ...
    h.prototype.set_first_party_cookie = function(a) {
        a = this.get_first_party_cookie() || a;
        var b = this._get_etld(),
            c = window.location.hostname;
        if (a) return this._cookie_source = "got", b && c !== b && this.set("__adroll_fpc", a, -8760, c), this.set("__adroll_fpc", a, 8766, b || c), this.__adroll_fpc = a, this._queueAndCallback("_fpc_callback", [a]), a;
        ...
        this.__adroll_fpc = a;
        this._queueAndCallback("_fpc_callback", [d]);
        return d
    };
    h.prototype.get_cookie = function(a, b) {
        this._registerCallback("_fpc_callback", a, b)
    };
    h.prototype._fpc_callback = function(a) {
        return a
    };
    h.prototype._get_fpc_source = function() {
        return this._cookie_source
    };
    h.prototype.get_first_party_cookie = function() {
        try {
    ...
    h.prototype._get_fpid_ls = function() {
        return window.localStorage.getItem("__adroll_fpc")
    };
    h.prototype._set_fpid_ls = function(a) {
        window.localStorage.setItem("__adroll_fpc", a)
    };
    h.prototype._get_fpid_idb = function(a) {
        var b = this;
        this._get_idb_row("__adroll_fpc", function(c) {
            a && a.call(b, (c || {}).val)
        })
    };
    h.prototype._set_fpid_idb = function(a) {
        this._set_idb_row("__adroll_fpc", {
            val: a
        })
    };
    h.prototype._sync_fpid = function() {
        var a = this;
        ...
        this.jsonStringifyFunc = a && a.stringify && "function" === typeof a.stringify ? a.stringify : function() {
            ...
            return function m(e) {
                ...
                if ("object" === typeof e) {
                    ...
                    if (d(e)) {
                        for (var q = "[", l = 0; l < e.length; l++) q += (l ? ", " : "") + m(e[l]);
                        return q + "]"
                    }
                    if ("[object Object]" === c.call(e)) {
                        q = [];
                        for (l in e) e.hasOwnProperty(l) && q.push(m(l) + ": " + m(e[l]));
                        return "{" + q.join(", ") + "}"
                    }
                }
    ...
    h.prototype._lzstring = function() {
        function a(a, b) {
            if (!c[a]) {
                c[a] = {};
        ...
        var b = String.fromCharCode,
            ...
            d = {
                ...
                compressToUint8Array: function(a) {
                    a = d.compress(a);
                    for (var b = new Uint8Array(2 * a.length), c = 0, m = a.length; c < m; c++) {
                ...
                decompressFromUint8Array: function(a) {
                    ...
                    for (var c = Array(a.length / 2), f = 0, m = c.length; f < m; f++) c[f] = 256 * a[2 * f] + a[2 * f + 1];
                    var k = [];
                ...
                _compressChunk: function(a, b, c, m) {
                    Object.prototype.hasOwnProperty.call(c,
                        a) ? (256 > a.charCodeAt(0) ? (d._compressBits(0, m.numBits, m), d._compressBits(a.charCodeAt(0), 8, m)) : (d._compressBits(1, m.numBits, m), d._compressBits(a.charCodeAt(0), 16, m)), m.enlargeIn--, 0 === m.enlargeIn && (m.enlargeIn = Math.pow(2, m.numBits), m.numBits++), delete c[a]) : d._compressBits(b[a], m.numBits, m);
                    m.enlargeIn--;
                    0 === m.enlargeIn && (m.enlargeIn = Math.pow(2, m.numBits), m.numBits++)
                },
                _compress: function(a, b, c) {
                    ...
                    for (m = 0; m < a.length; m += 1) l = a.charAt(m), Object.prototype.hasOwnProperty.call(k, l) || (k[l] = r.dictSize++, q[l] = !0), n = p + l, Object.prototype.hasOwnProperty.call(k, n) ? p = n : (d._compressChunk(p, k, q, r), k[n] = r.dictSize++, p = String(l));
    ...
    h.prototype.encode_utf8 = function(a) {
        return encodeURIComponent(a).replace(/%([0-9A-F]{2})/g, function(a, c) {
            return String.fromCharCode("0x" + c)
        })
    };
    h.prototype.decode_utf8 = function(a) {
    ...
    h.prototype.macro_values = function() {
        var a = this._ensure_global("adroll_cpm_macro", null),
            ...
            m = this._ensure_global("adroll_debug_string", null),
            ...
            n = {};
        a && !l.test(a) && (n.adroll_cpm_macro = a);
        m && !l.test(m) && (n.adroll_debug_string = m);
        k && !l.test(k) && (n.adroll_ad_container_version = k);
        b && !l.test(b) && (n.adroll_url_macro = b);
        c && !l.test(c) && (n.adroll_c_macro = c);
        d && !l.test(d) && (n.adroll_subnetwork = d);
        e && !l.test(e) && (n.adroll_ad_payload = e);
        g && !/^[|$]/.test(g) && (n.adroll_win_notif = g);
        q && !l.test(q) && (n.adroll_pixalate_click_url = q);
    ...
    h.prototype.macro_url_params = function(a, b, c, d, e) {
        ...
        var g = d ? window.escape : function(a) {
            ...
            m = a.adroll_url_macro,
            k = c ? a.adroll_c_macro : null,
            q = [],
            l = this.is_lenient_click(b);
        k && 0 === k.indexOf("http") ? (l = g, "g" === this._global("adroll_ext_network") && (l = d ? function(a) {
            return a
        } : window.unescape), q.push(["clickurl", l(k)])) : l && e && q.push(["clickurl", ""]);
        this._global("adroll_ad_destination_url") && !e && (q.push(["desturl", g(this._global("adroll_ad_destination_url"))]),
        ...
        a.adroll_debug_string && q.push(["debug_string", g(a.adroll_debug_string)]);
        a.adroll_ad_container_version && q.push(["adroll_ad_container_version",
            g(a.adroll_ad_container_version)
        ]);
        a.adroll_pixalate_click_url && q.push(["adroll_pixalate_click_url", g(a.adroll_pixalate_click_url)]);
        m && (a = this.parseUri(window.unescape(m)), q.push(["site_url", g("http://" + a.host)]), c && (q.push(["adroll_width", g(this._global("adroll_width"))]), q.push(["adroll_height", g(this._global("adroll_height"))])));
    ...
    h.prototype.replace_user_macros = function(a, b) {
        var c = Math.random(),
            d = 1E16 * c,
        ...
        for (g in d)
            if (d.hasOwnProperty(g)) {
                var f = d[g];
                f && (a = a.replace(new RegExp(c.source + g + e.source, "gi"), f))
            }
        return a
    };
    ...
    h.prototype.startswith = function(a, b) {
    ...
    h.prototype.md5 = function() {
        ...
        function c(a, c, d, e, g, f, r) {
            return b(c & d | ~c & e, a, c, g, f, r)
        }

        function d(a, c, d, e, g, f, r) {
            return b(c & e | d & ~e, a, c, g, f, r)
        }

        function e(a, c, d, e, g, f, r) {
            return b(d ^ (c | ~e), a, c, g, f, r)
        }
        ...
        function g(g, k) {
            var f = g[0],
                ...
                n = g[2],
                p = g[3],
                f = c(f, l, n, p, k[0], 7, -680876936),
                p = c(p, f, l, n, k[1], 12, -389564586),
                n = c(n, p, f, l, k[2], 17, 606105819),
                l = c(l, n, p, f, k[3],
                    22, -1044525330),
                f = c(f, l, n, p, k[4], 7, -176418897),
                p = c(p, f, l, n, k[5], 12, 1200080426),
                n = c(n, p, f, l, k[6], 17, -1473231341),
                l = c(l, n, p, f, k[7], 22, -45705983),
                f = c(f, l, n, p, k[8], 7, 1770035416),
                p = c(p, f, l, n, k[9], 12, -1958414417),
                n = c(n, p, f, l, k[10], 17, -42063),
                l = c(l, n, p, f, k[11], 22, -1990404162),
                f = c(f, l, n, p, k[12], 7, 1804603682),
                p = c(p, f, l, n, k[13], 12, -40341101),
                n = c(n, p, f, l, k[14], 17, -1502002290),
                l = c(l, n, p, f, k[15], 22, 1236535329),
                f = d(f, l, n, p, k[1], 5, -165796510),
                p = d(p, f, l, n, k[6], 9, -1069501632),
                n = d(n, p, f, l, k[11], 14, 643717713),
                l = d(l,
                    n, p, f, k[0], 20, -373897302),
                f = d(f, l, n, p, k[5], 5, -701558691),
                p = d(p, f, l, n, k[10], 9, 38016083),
                n = d(n, p, f, l, k[15], 14, -660478335),
                l = d(l, n, p, f, k[4], 20, -405537848),
                f = d(f, l, n, p, k[9], 5, 568446438),
                p = d(p, f, l, n, k[14], 9, -1019803690),
                n = d(n, p, f, l, k[3], 14, -187363961),
                l = d(l, n, p, f, k[8], 20, 1163531501),
                f = d(f, l, n, p, k[13], 5, -1444681467),
                p = d(p, f, l, n, k[2], 9, -51403784),
                n = d(n, p, f, l, k[7], 14, 1735328473),
                l = d(l, n, p, f, k[12], 20, -1926607734),
                f = b(l ^ n ^ p, f, l, k[5], 4, -378558),
                p = b(f ^ l ^ n, p, f, k[8], 11, -2022574463),
                n = b(p ^ f ^ l, n, p, k[11], 16, 1839030562),
                l = b(n ^ p ^ f, l, n, k[14], 23, -35309556),
                f = b(l ^ n ^ p, f, l, k[1], 4, -1530992060),
                p = b(f ^ l ^ n, p, f, k[4], 11, 1272893353),
                n = b(p ^ f ^ l, n, p, k[7], 16, -155497632),
                l = b(n ^ p ^ f, l, n, k[10], 23, -1094730640),
                f = b(l ^ n ^ p, f, l, k[13], 4, 681279174),
                p = b(f ^ l ^ n, p, f, k[0], 11, -358537222),
                n = b(p ^ f ^ l, n, p, k[3], 16, -722521979),
                l = b(n ^ p ^ f, l, n, k[6], 23, 76029189),
                f = b(l ^ n ^ p, f, l, k[9], 4, -640364487),
                p = b(f ^ l ^ n, p, f, k[12], 11, -421815835),
                n = b(p ^ f ^ l, n, p, k[15], 16, 530742520),
                l = b(n ^ p ^ f, l, n, k[2], 23, -995338651),
                f = e(f, l, n, p, k[0], 6, -198630844),
                p = e(p, f, l, n, k[7], 10, 1126891415),
                n = e(n, p, f, l, k[14], 15, -1416354905),
                l = e(l, n, p, f, k[5], 21, -57434055),
                f = e(f, l, n, p, k[12], 6, 1700485571),
                p = e(p, f, l, n, k[3], 10, -1894986606),
                n = e(n, p, f, l, k[10], 15, -1051523),
                l = e(l, n, p, f, k[1], 21, -2054922799),
                f = e(f, l, n, p, k[8], 6, 1873313359),
                p = e(p, f, l, n, k[15], 10, -30611744),
                n = e(n, p, f, l, k[6], 15, -1560198380),
                l = e(l, n, p, f, k[13], 21, 1309151649),
                f = e(f, l, n, p, k[4], 6, -145523070),
                p = e(p, f, l, n, k[11], 10, -1120210379),
                n = e(n, p, f, l, k[2], 15, 718787259),
                l = e(l, n, p, f, k[9], 21, -343485551);
            g[0] = a(f, g[0]);
            g[1] = a(l, g[1]);
            g[2] = a(n, g[2]);
            g[3] =
    ...
    h.prototype._log_multiple_ids = function() {
        var a = this;
        this.if_under_experiment_js("multidexp", function() {
            a._log_pex_event("multid", "load", "", "", "")
        }, function() {})
    };
    h.prototype._init_floc_trial = function() {
    ...
    h.prototype._log_floc_cohort = function() {
    ...
    h.prototype._log_pex_event = function(a, b, c, d, e) {
        ...
        var m = "";
        "object" === typeof d && (m = "&" + this.object_to_querystring(d));
        d = this._srv("/pex/" + g + "/" + f + "?ev=" + a + "&es=" + b + "&esv=" + c + "&pv=" + this.pv + m + e);
        "function" === typeof navigator.sendBeacon ? navigator.sendBeacon(d) : this.imgRequest(d)
    };
    h.prototype._pixel_timing = function(a, b, c) {
        function d() {
            m.session_time += (new Date).getTime() - (c || 0)
        }

        function e(a, b) {
            var d = b;
            18E5 < m.session_time && (d = "newsession", m.preconsent_sent = !1, m.prepixel_sent = !1);
            b = d;
            if (!("preconsent" === b && m.preconsent_sent || "prepixel" === b && m.prepixel_sent)) {
                d = b;
                m.preconsent_sent = m.preconsent_sent || "preconsent" === d;
                m.prepixel_sent = m.prepixel_sent || "prepixel" === d;
                "newsession" === b && (a = 0, c = k = (new Date).getTime(), m.pixelstart = k, m.session_time = 0);
                d = ["f=" + a];
                "undefined" !== typeof b &&
                    d.push("ft=" + b);
                var e = m._global("adct");
                e && "undefined" !== e && d.push("adct=" + window.escape(e));
                d = encodeURIComponent(d.join("&"));
                d = m._srv("/onp/" + m._global("adroll_adv_id") + "/" + m._global("adroll_pix_id") + "?ev=" + d);
                "function" === typeof navigator.sendBeacon ? navigator.sendBeacon(d) : m.imgRequest(d)
            }
        }

        function g(a, b) {
            window.setTimeout(function() {
                !b || !0 !== window.__adroll_consent && !0 !== (window.__adroll_consent || {}).a || (d(), e(m.session_time, "preconsent"), "object" === typeof window.performance && e(m.pixelstart - window.performance.timing.domInteractive,
                    "prepixel"))
            }, 500 * Math.random())
        }

        function f(a) {
            if ("visible" === window.document.visibilityState || a.type in q) m._pixel_timing(!1, !1, k);
            else if ("hidden" === window.document.visibilityState || a.type in l) !0 === window.__adroll_consent || !0 === (window.__adroll_consent || {}).a ? (d(), e(m.session_time)) : d()
        }
        var m = this,
            k = (new Date).getTime(),
            q = ["focus", "focusin", "pageshow"],
            l = ["blur", "focusout", "pagehide"];
        0 === m.pixelstart && (m.pixelstart = k);
    ...
    h.prototype.extract_pid = function(a, b, c) {
        ...
        q && (g = q.product_id, e = q.product_group, f = q.product_action, m = q.adroll_product_category_id);
        if (!g && a.regexp_group && !("string" === a.regexp_group && a.regexp_group instanceof String) && "html" === a.regexp_group.scheme) {
            ...
            g = this.get_product_id_from_url(k, a.regexp, a.regexp_group)
        }
        ...
        this.extract_pid(a, "adroll", function(a) {
            if (a) {
                ...
                if (g instanceof Array)
                    ...
                    a.push(["adroll_product_category_id", this.normalize_var((g + "").toLowerCase(), !0)]);
    ...
    h.prototype.store_adroll_loaded_record = function(a, b) {
    ...
    h.prototype.render_pixel_code_exec = function(a, b) {
        ...
        this.addLoadEvent(function(d) {
            return function() {
                ...
                try {
                    var g = d.get_conversion_value();
                    g.conv_value && e.push("conv_value=" + g.conv_value);
                    g.currency && e.push("adroll_currency=" + g.currency)
                } catch (l) {}
                try {
                ...
                try {
                    var m = d._global("adct"),
                        k = d.extract_query_param("adct", window.location.search.substr(1));
                    k && "undefined" !== k && m !== k && (d._set_global("adct", k), e.push("adct=" + window.escape(k)))
                } catch (l) {}
                try {
                    d._has_global("adroll_shop_id") && (g = {}, d._has_global("adroll_custom_data") ? g = d._global("adroll_custom_data") : d._set_global("adroll_custom_data", g), "undefined" === typeof g.adroll_shop_id && (g.adroll_shop_id = d._global("adroll_shop_id")));
        ...
        this.addLoadEvent(function(a) {
            return function() {
                ...
                if (b && "object" ===
                    ...
                    b.get_cookie = function() {
                        return a.get_cookie.apply(a, arguments)
                    };
                    for (var c, f, m = 0; m < b.length; m++) c = b[m][0], f = b[m][1], "identify" === c ? a.identify.apply(a, f) : "identify_email" === c ? a.identify_email.apply(a, f) : "track" === c && a.track.apply(a, f)
                }
            }
        }(this))
    };
    h.prototype.render_ad_code = function(a, b) {
    ...
    h.prototype.get_base_url = function(a, b, c, d, e, g) {
        var f = a.split("?");
        a = f[0] + "/" + b + "/" + c + (d ? "/" + d : "") + (e ? "/" + e : "");
        var m = "?";
        f[1] && (a += "?" + f[1], m = "&");
        var f = m + "no-cookies=1",
            k = "";
        this.cookieEnabled(!1) ? (k = window.escape(this.get_eids()), a += m + "cookie=" + k) : a += f;
        g && (a += "&" + g.join("&"));
    ...
    h.prototype.sha256 = function(a) {
        ...
        var c = window.unescape(window.encodeURIComponent(a)),
            ...
            q = [];
        e = 0;
        for (var l = {}, n = 2; 64 > e; n++)
            if (!l[n]) {
                for (a = 0; 313 > a; a += n) l[a] = n;
                k[e] = Math.pow(n, .5) * d | 0;
                q[e++] = Math.pow(n, 1 / 3) * d | 0
            }
        ...
        for (e = 0; e < f.length;) {
            ...
            for (a = 0; 64 > a; a++) {
                var l = c[a - 15],
                    ...
                    m = k[0],
                    p = k[4],
                    l = k[7] + (b(p, 6) ^ b(p, 11) ^ b(p, 25)) + (p & k[5] ^ ~p & k[6]) + q[a] + (c[a] = 16 > a ? c[a] : c[a - 16] + (b(l, 7) ^ b(l, 18) ^ l >>> 3) + c[a - 7] + (b(n, 17) ^ b(n, 19) ^ n >>> 10) | 0),
                    m = (b(m, 2) ^ b(m, 13) ^ b(m, 22)) + (m & k[1] ^ m & k[2] ^ k[1] & k[2]),
                    k = [l + m | 0].concat(k);
                k[4] = k[4] + l | 0
            }
    ...
    h.prototype.record_adroll_private_email = function(a) {
        this._record_adroll_email(a, "/idp")
    };
    h.prototype._record_adroll_email = function(a, b) {
        if (this._has_email()) {
            ...
            for (e = 0; e <
                g.length; e++) this.imgRequest(this._srv(c + "/" + g[e][0] + "/" + d))
        }
    };
    ...
    h.prototype.identify_email = function(a) {
        var b = this;
    ...
    h.prototype._track_pxl_assistant = function(a, b) {
    ...
    h.prototype.has_param_in_url = function(a, b) {
        var c = a.split("?");
        return 1 < c.length && -1 !== ("&" + c[1]).indexOf("&" + b + "=")
    };
    h.prototype._srv = function(a, b) {
    ...
    h.prototype._get_arrfrr = function(a) {
    ...
    h.prototype.is_luhn = function(a) {
    ...
    h.prototype.repeatstr = function(a, b) {
    ...
    h.prototype.b64toint = function(a) {
        return parseInt(this.b64tobits(a), 2)
    };
    h.prototype.bitstob64 = function(a, b) {
        var c = "",
            d;
    ...
    h.prototype.extendObj = function(a, b) {
    ...
    h.prototype.object_keys = function(a) {
    ...
    h.prototype.add_fpc_to_url = function(a, b) {
    ...
    h.prototype.add_consent_to_url = function(a) {
        if (!a) return a;
    ...
    h.prototype.call_next_tpc = function() {
    ...
    h.prototype.load_pixel_assistant = function() {
    ...
    h.prototype._set_webworker_vars = function() {
    ...
    h.prototype.set_suspended = function() {
        this._set_global("__adroll_data_suspended", !0)
    };
    h.prototype.is_suspended = function() {
        return this._has_global("__adroll_data_suspended")
    };
    h.prototype.object_to_querystring = function(a) {
        var b = null;
    ...
    h.prototype._get_lex_timeout = function() {
        return 1E3
    };
    h.prototype.is_ipv6 = function() {
        return (this._global("__adroll_consent_data") || {}).isipv6
    };
    h.prototype._call_33across = function(a) {
        function b() {
            a && a.call(c)
        }
        var c = this;
    ...
    h.prototype.set_lex_id = function(a) {
    ...
    h.prototype._reg_lpq = function(a, b) {
        var c, d, e = [],
            g = {},
    ...
    x && 0 <= w.indexOf(x.substr(0, 1)) ? (window.__adroll_v1_to_v2_shim = !0, window.adroll_version = "2.0", function(a, b, c, d, e) {
        ...
        var g = "https://s.adroll.com/j/" + x + "/roundtrip.js";
        ...
        d.parentNode.insertBefore(c,
            d)
    }(window, document), window.adroll.track("pageView")) : window.__adroll = window.__adroll || new h;
}());
(function(a) {
    a.adroll_optout = !1;
