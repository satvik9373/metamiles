    ...
    var p = function() {
        function Visitor(e) {
            ! function visitor_classCallCheck(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, Visitor), this._id = null, this._accountId = e, this._email = null, this._referrer = n.getReferrer(), this._url = n.getLocation(), this._hasWhitelistedServices = !1, this._whitelistedServices = [], this._addedServices = [], this._processedServices = {}, this._trackByDefault = !1, this._siteAllowParameter = !0
        }
        ...
        g = function() {
            ...
            return function diffuser_createClass(e, t, r) {
                ...
                value: function _makeRequestToDiffuser(e, t) {
                    ...
                    this._removeQueryParam(e.siteAllowParameter), this._checkQueryParam(e.accountId) && "" === o[h] && (o[h] = atob(getTempEeCookie()));
                ...
                value: function _removeQueryParam(e) {
                    if (-1 !== window.location.href.indexOf("vgo_ee")) {
                        var t = this._checkResponseStatusExists(window.performance.getEntriesByName(window.location.href), e);
                        ! function setTempEeCookie(e) {
                            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                                r = getTempCookieExpiration(),
                                n = "." + window.location.hostname.split(".").slice(-2 - t).join(".");
                            document.cookie = "".concat("temp_ee", "=").concat(e, ";domain=").concat(n, ";path=/;expires=").concat(r.toUTCString());
                            var o = getTempEeCookie();
                            if (!o && t < 10) return setTempEeCookie(e, t + 1)
                        }(btoa(n.getQueryParam("vgo_ee"))), window.history.replaceState(window.history.state, document.title, n.getPathname()), t && window.location.replace(window.location.href)
                    }
                }
            }, {
                key: "_checkResponseStatusExists",
                value: function _checkResponseStatusExists(e, t) {
                    if (1 === e.length && void 0 !== e[0].responseStatus) return 404 === e[0].responseStatus;
                    if (!1 === t) {
                        var r = new XMLHttpRequest;
                        return r.open("GET", window.location.href, !1), r.send(null), 404 === r.status
                    }
                    return !1
                }
            }, {
